...
network.resnet.RPN_FEAT_STRIDE = [64, 32, 16, 8, 4]
network.resnet.RCNN_FEAT_STRIDE = [32, 16, 8, 4]
network.resnet.RPN_MIN_SIZE = network.resnet.RPN_FEAT_STRIDE
network.resnet.FIXED_PARAMS = ['conv0', 'stage1', 'gamma', 'beta']
network.resnet.FIXED_PARAMS_SHARED = ['conv0', 'stage1', 'stage2', 'stage3', 'stage4',
                                          'P5', 'P4', 'P3', 'P2',
                                          'gamma', 'beta']
